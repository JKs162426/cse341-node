...
async function main() {
    const uri = "mongodb+srv://JKs162426:04120821412jk@cluster0.km0vb1l.mongodb.net/?appName=Cluster0"
...
async function findListingWithMinimumBedroomsAndMostRecentReviews(client, {
    ...
    if (results.length > 0) {
        ...
        results.forEach((result, i) => {
            ...
            console.log(`${i + 1}. name: ${result.name}, bedrooms: ${result.bedrooms}, bathrooms: ${result.bathrooms}, most recent review date: ${date}`);
        });
    }
}
